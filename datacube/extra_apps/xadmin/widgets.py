...
class AdminSelectWidget(forms.Select):
    ...
    @property
    def media(self):
        return vendor('select.js', 'select.css', 'xadmin.widget.select.js','xadmin.widget.issuecategoryselect.js') # 添加issue cateage联动 xadmin.widget.issuecategoryselect.js
