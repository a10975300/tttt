...
var DFA_bar1_colors = [blue,orange];
...
var DFA_bar1_build = 0
var DFA_bar2_build = 0
var DFA_bar3_build = 0
var DFA_bar4_build = 0
...
var progressBar = document.getElementById('progress-bar'); // 修改变量名为 progressBar
if (ES_i5_text5) {
...
//DFA-bar1
DFA_bar1_build=1
var ctx = document.getElementById("DFA-bar1");
 DFA_bar1 = new Chart(ctx, {
    type: 'bar',
        data: {
...
//DFA-bar2
DFA_bar2_build=1
var ctx = document.getElementById("DFA-bar2");
 DFA_bar2 = new Chart(ctx, {
    type: 'bar',
        data: {
...
//DFA-bar3
DFA_bar3_build=1
var ctx = document.getElementById("DFA-bar3");
 DFA_bar3 = new Chart(ctx, {
    type: 'bar',
        data: {
        labels: ['Bonding','Gluing','Assembly','Screwing','Cables Assembly','Material Scan & link'],
            datasets: [
...
//DFA-bar2
DFA_bar4_build=1
var ctx = document.getElementById("DFA-bar4");
 DFA_bar4 = new Chart(ctx, {
    type: 'bar',
        data: {
        labels: ['Bonding','Gluing','Assembly','Screwing','Cables Assembly','Material Scan & link'],
            datasets: [
