...
# handle new issue form submit
class SubmitIssue(View):
    def get(self, request):
        pass

    def post(self, request):
        issuetype = request.POST.get("issuetype") # get issuetype
        ...
        messages.success(request, "{}-{}'s safe-launch data was imported successfully.".format(new_issue.platformName,issuetype))
